...
namespace SnowyPeak.Duality.Plugin.Frozen.FX
{
    ...
    internal class Particle
    {
        ...
        internal Vector2 Movement { get; set; }
        ...
        internal void SetData(ParticleMaterial inMaterial, Vector3 inPosition, float inMovementSpeed, float inRotationSpeed, float inScaleSpeed, float inInitialRotation, float inInitialDirection, float inInitialScale, float inTimeToLive, ColorRange inColorRange, float randomFactor)
        {
            ...
            Movement = new Vector2(MathF.Cos(inInitialDirection), MathF.Sin(inInitialDirection)) * inMovementSpeed;
        ...
        internal void AlterDirection(Vector2 change)
        {
            Movement += change;
        }
        ...
        internal void Update(float inElapsedTimeInSeconds)
        {
            ...
            if (IsAlive)
            {
                ...
                newPosition.Xy += (Movement * inElapsedTimeInSeconds);
